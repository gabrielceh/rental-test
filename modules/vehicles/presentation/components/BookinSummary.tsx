...
const BookingSummary = ({ vehicle, location, pickUp, dropOff, }: BookingSummaryProps) => {
  const days = useMemo(() => getDaysDifference(pickUp, dropOff), [pickUp, dropOff]);
  ...
  return (
    <div className="w-full max-w-lg mx-auto space-y-6">
        ...
        <div className="p-6 space-y-5">
          ...
          <div className="border-t border-gray-300 pt-4 space-y-2">
            <div className="flex justify-between text-sm text-muted-foreground">
              <span>${vehicle.price} × {days} día(s)</span>
              <span>${total}</span>
            </div>
      ...
      <Button onClick={handleContinue} className="w-full flex items-center justify-center gap-2">
